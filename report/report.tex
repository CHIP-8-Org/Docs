...
\begin{table}[h!t] % [ht]
    ...
    \begin{tabular}{|llll|l|}
        ...
        \multicolumn{4}{|r|}{\textbf{Totale}}                                                      & 41.50\euro    \\ \hline
    \end{tabular}
    \caption{
...
Internamente alla base di supporto, i collegamenti sono rimasti quelli descritti in sezione \ref{subsubsec:collegamenti} visibili in figura \ref{fig:schematic}. Ma abbiamo aggiunto delle batterie esterne come alimentazione per la scheda evitando di doverla collegare ad una presa di corrente. Come si pu\'o notare in figura \ref{fig:box1} lo schermo \'e esterno alla scatola per permettere l'incastro con la scheda attraverso i pins dello \textit{shield} in modo da non utilizzare colla o nastri adesivi. Per il keypad abbiamo utilizzato un nastro biadesivo per attaccarlo alla base di supporto, in quanto le lettere del keypad non rispecchiavano le originali del Cosmac Vip\footnote{https://en.wikipedia.org/wiki/COSMAC\_VIP} abbiamo deciso di ricoprire i tasti incorretti con un adesivo indicante la lettera originale.
