...
\begin{figure}[h]
    \begin{subfigure}[b]{0.45\textwidth}
        \begin{center}
            \includegraphics[scale=0.15]{figures/stm32f334.jpg}
        \end{center}
        \caption{LIl microcontrollore \texttt{STM32F334R8T6}.}
        \label{fig:ili9341}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
...
Necessiteremo inoltre di un display TFT LCD (thin-film-transistor
liquid-crystal display) a colori retroilluminato, per poterci interfacciare
col gioco. Questo display, da 2.4 pollici, é basato sul controller
\texttt{ILI9341} e ha una risoluzione di 320$\times$240 \texttt{px}.
...
La piattaforma scelta per lo sviluppo del progetto é il microcontrollore
STM32F334R8T6, un microcontrollore a 32 bit con 16 KB di SRAM e 64 KB di
Flash. Il microcontrollore é dotato di un clock a 72 MHz, 51 pin GPIO,
